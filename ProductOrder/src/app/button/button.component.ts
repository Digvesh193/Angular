...
export class ButtonComponent extends ProductBase implements OnInit {
  ...
  isSubmit : boolean = false
	constructor(private modalService: NgbModal,private itemStorageService: ItemStorageService,private observableService: ObservableService) {
    super() 
  }
